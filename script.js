...
const PRODUCTS = [
  ...
  {
    id: "p-Logitech-G-PRO-X-Superlight-2",
  ...
  {
    id: "p-HyperX-Cloud-III-Wireless",
  ...
  },
  {
   ...
   {
    id: "p-Logicool-G-PRO-2-LIGHTSPEED",
  ...
  },
  {
   ...
   {
    id: "p-Wallhack-初音ミク-ガラス製ゲーミングマウスパッド",
  ...
  {
    id: "p-Logicool-G-PRO-X-SUPERLIGHT",
  ...
  {
    id: "p-Razer-Viper-V3-Pro-Sentinels-Edition",
  ...
  {
    id: "p-Pulsar-Gears-PCMK-2HE-TKL",
  ...
  {
    id: "p-Pulsar-ES2-Dep-Edition",
    name: "Pulsar ES2 Dep Edition",
    brand: "Pulsar",
    type: "mousepad",
    priceJPY: null,
  ...
  {
    id: "p-EsportsTiger-GRANDMASTER-PINK",
  ...
  {
    id: "p-Razar-Viper-V3-Pro-Faker-Edition",
  ...
  {
    id: "p-SteelSeries-Apex-Pro-Mini",
  ...
  {
    id: "p-BenQ-ZOWIE-XL2566X+",
    name: "BenQ ZOWIE XL2566X+",
    brand: "BenQ",
    type: "monitor",
    priceJPY: 117979,
    image: "https://m.media-amazon.com/images/I/51uiSJ+af+L._UF1000,1000_QL80_.jpg",
    tags: [],
    popularity: 90,
    addedAt: "2025-07-02",
    affiliate: "https://amzn.to/3KVgB8j",
  },
  {
    id: "p-D-GLOW-LAN",
    name: "D-GLOW LAN",
    ...
    type: "mousepad",
    priceJPY: null,
    image: "https://m.media-amazon.com/images/I/71QY113FZjL.jpg",
    tags: [],
    popularity: 90,
    addedAt: "2025-07-02",
    affiliate: "https://amzn.to/3JdhEjv",
  },
];
...
const PLAYERS = [
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-Apple-EarPods" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-水月雨-Moondrop-Blessing-3" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-HyperX-Cloud-III-Wireless" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-KZ-ZS10-PRO" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Mouse", itemId: "p-Razer-Viper-V3-Pro" },
      { role: "Mousepad", itemId: "p-BenQ-ZOWIE-G-SR-II" },
      { role: "Headset", itemId: "p-Fanmusic-Truthear-Hexa" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Mouse", itemId: "p-Razer-Viper-V3-Pro-Faker-Edition" },
  ...
  },
  {
    ...
    team: "ZETA",
    devices: [
      { role: "Keyboard", itemId: "p-ZENAIM-KEYBOARD" },
      { role: "Mouse", itemId: "p-Logicool-GPRO-X-SUPERLIGHT-2-DEX" },
      { role: "Mousepad", itemId: "p-VAXEE-PD" },
      { role: "Headset", itemId: "p-SHURE-SE215-CL-A" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    team: "ZETA",
    devices: [
      { role: "Keyboard", itemId: "p-Pulsar-Gears-PCMK-2HE-TKL" },
      { role: "Mouse", itemId: "p-Razer-Viper-V3-Pro-Sentinels-Edition" },
      { role: "Mousepad", itemId: "p-Pulsar-ES2-Dep-Edition" },
      { role: "Headset", itemId: "p-Sennheiser-GAME-ZERO" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2546K" },
    ],
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-SHURE-SE846" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      { role: "Keyboard", itemId: "p-wooting-60HE" },
      { role: "Mouse", itemId: "p-Logicool-G-PRO-X-Superlight-2" },
      { role: "Mousepad", itemId: "p-D-GLOW-LAN" },
      { role: "Headset", itemId: "p-SONY-INZONE-H9" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Mouse", itemId: "p-Logicool-G-PRO-X-Superlight-2" },
      { role: "Mousepad", itemId: "p-EsportsTiger-GRANDMASTER-PINK" },
      { role: "Headset", itemId: "p-SHURE-SE215-CL-A" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headset", itemId: "p-Razer-BlackShark-V2-Pro-White-Edition" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      { role: "Keyboard", itemId: "p-wooting-60HE" },
      { role: "Mouse", itemId: "p-Logicool-G-PRO-X-SUPERLIGHT-レッド" },
      { role: "Mousepad", itemId: "p-ARTISAN-NINJA-FX-ZERO" },
      { role: "Headset", itemId: "p-SHURE-SE215-CL-A" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    team: "DFM",
    devices: [
      { role: "Keyboard", itemId: "p-SteelSeries-Apex-Pro-Mini" },
      { role: "Mouse", itemId: "p-ZYGEN-NP-01S-オレンジ" },
      { role: "Mousepad", itemId: "p-ARTISAN-NINJA-FX-ZERO" },
      { role: "Headset", itemId: null },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
