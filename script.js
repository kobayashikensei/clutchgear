...
const PLAYERS = [
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Headsets", itemId: "p-HyperX-Cloud-III-Wireless" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "headsets", itemId: "p-SHURE-SE215" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "Mousepad", itemId: "p-p-D-GLOW-LAN" },
  ...
  },
  {
    ...
    devices: [
      ...
      { role: "headsets", itemId: "p-Razer-BlackShark-V2-Pro-White-Edition" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
  ...
  },
   {
    ...
    devices: [
      { role: "Keyboard", itemId: "p-wooting-60HE" },
      { role: "Mouse", itemId: "p-Logicool-G-PRO-X-SUPERLIGHT-Red" },
      { role: "Mousepad", itemId: "p-Artisan-NINJA-FX" },
      { role: "headsets", itemId: "p-SHURE-SE215" },
      { role: "Monitor", itemId: "p-BenQ-ZOWIE-XL2566K" },
    ],
